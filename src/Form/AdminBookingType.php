...
class AdminBookingType extends ApplicationType
{
    ...
    {
        $builder
            ->add('startDate',  DateType::class, $this->getConfiguration("Date d'arrivée", "Date à laquelle l'utilisateur arrive", [
                "widget"=>"single_text"
            ]))
            ->add('endDate',DateType::class, $this->getConfiguration("Date de départ", "Date à laquelle l'utilisateur part",[
                "widget"=>"single_text"
            ]))
